...
// addRelatedOnce adds `ref` to the slice pointed to by `related` if an equivalent
...
// existing order and appends new entries. If `related` is nil it will be
// initialized. The slice pointed to by `related` is mutated in-place.
